...
public final class Person extends Table {
  ...
  public int friendShipStatus() { int o = __offset(6); return o != 0 ? bb.getInt(o + bb_pos) : 0; }
  public boolean mutateFriendShipStatus(int friendShipStatus) { int o = __offset(6); if (o != 0) { bb.putInt(o + bb_pos, friendShipStatus); return true; } else { return false; } }
  ...
  public static void addFriendShipStatus(FlatBufferBuilder builder, int friendShipStatus) { builder.addInt(1, friendShipStatus, 0); }
